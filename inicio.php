...
<body>
  ...
  <div class="contenedor">
    <nav class="navbar navbar-dark  fixed-top nav">
      <div class="container-fluid">
        <a class="navbar-brand" href="#" >Cursos Online</a>
        <button class="navbar-toggler toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar"
        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar"
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              <li class="nav-item">
                <a class="nav-link" href="login/registrese.php">Registrese</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./login/inicio.php">Iniciar sesión</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./login/acciones/cerrar copy.php">Cerrar sesión</a>
              </li>
