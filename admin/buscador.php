...
<head>
  ...
  <title>manipulacion productos</title>
...
$query= "SELECT Id, Nombre, Descripcion, Imagen, Valor, Tipo, Vendedor FROM productos 
...
while ($contenido = $fila->fetch_assoc()) { ?>
         ...
         <tr>
          ...
          <td>
            <?php echo $contenido['Vendedor'] ?>
          </td>
           <td>
            <button class="btn btn-small btn-warning" data-bs-toggle="modal"
              data-bs-target="#modaleditar<?php echo $contenido['Id']?>"><i class="fa-solid fa-pen-to-square" style="color: #000000;"></i></button>
            <button class="btn btn-small btn-danger" data-bs-toggle="modal"
              data-bs-target="#modaleliminar<?php echo $contenido['Id']?>"><i class="fa-solid fa-trash" style="color: #000000;"></i></button>
          </td>
